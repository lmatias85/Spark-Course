...
names = spark.read.schema(schema).option("sep", " ").csv("C:/repositorios/Spark-Course/data/marvel/Marvel+Names")

lines = spark.read.text("C:/repositorios/Spark-Course/data/marvel/Marvel+Graph")
